    ...
    <section className="section-band bg-rice text-ink">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-16 lg:grid-cols-[0.8fr_1fr] lg:px-8 lg:py-20">
        <div>
          ...
          <h2 className="mt-4 max-w-2xl text-balance text-3xl font-semibold leading-tight md:text-5xl">{copy.title}</h2>
        </div>

        <div className="flex flex-col justify-end">
          <p className="max-w-3xl text-pretty text-base leading-8 text-ink/70 md:text-lg">{copy.body}</p>
