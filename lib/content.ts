...
export const siteContent = {
  zh: {
    ...
    portfolio: {
      eyebrow: "定位",
      title: "供应链 × AI 产品实验室。",
      body: "面向认真经营的商家、工厂、贸易商和供应链从业者。\n从配送排线、仓网选址，到采购报价对比、库存核对、需求预测——把日常重复、耗时、容易出错的供应链工作，变成可体验、可定制的 AI 工具。\n先解决一个具体问题。",
      points: ["可在线体验", "可定制适配", "可本地使用"]
    },
    threeWaysHeader: {
    ...
    community: {
      ...
      fit: ["年营收 5000 万以下的小微企业、工厂、贸易商、电商卖家", "有明确的供应链相关痛点", "各行业赛道各招募 1 位，共 5 位", "愿意提供脱敏数据，接受后续保存为 ChainFlow 案例"],
    ...
    about: {
      ...
      statement: "",
      paragraphs: [
        "Zilong Zhao，上海交通大学研究生在读，上海交通大学深圳行业研究院跨国企业供应链研究团队成员。关注小微企业及先进制造真实经营场景中的供应链问题，从具体工具开始，逐步探索 AI 智能体在业务流程中的落地。",
      ],
      focusLabel: "关注领域",
      focusAreas: [
        "汽车供应链",
