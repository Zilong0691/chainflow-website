...
export const siteContent = {
  zh: {
    ...
    portfolio: {
      eyebrow: "定位",
      title: "供应链 × AI 产品实验室。",
      body: "面向认真经营的小企业、商家和供应链从业者，提供可体验、可部署、可定制的 AI 工具。从排线、选址到采购决策，先解决一个具体问题。",
      points: ["可体验演示", "可部署到本地", "可定制适配"]
    },
    threeWaysHeader: {
    ...
    community: {
      ...
      subtitle: "ChainFlow 愿意用工具能力，和真实商家、小企业一起验证。",
      body: "",
      fitTitle: "适合谁",
      includesTitle: "免费试点包含",
      excludesTitle: "免费试点不包含",
      fit: ["年营收 5000 万以下的小微企业、工厂、贸易商、电商卖家", "有明确的供应链相关痛点", "各行业赛道各招募 1 位，共 5 位"],
